...
<body>
	...
	<nav class="navbar navbar-expand-lg navbar-light bg-light">
		...
		<li class="nav-item active"><a id="updatePW" class="nav-item nav-link active" href="${pageContext.request.contextPath}/updatePw">UpdatePassword</a></li>
				...
				<c:forEach items="${menuItems}" var="tempMenu" varStatus="temp">
					<tr>
						...
						<td>
							...
							data-target="#exampleModalCenter${tempMenu.id}">Details</a> <!-- Modal -->
	...
	<div class="container demotext">
		...
		For demo purposes, the Menu Controller/Editor will be open for you to
		demo the database functions.<br> Feel free to add, delete, update
		and search items. <br> <br> In order to preserve this demo,
		please do not delete all items or items that you have not created.<br>
		<br> <b>Note: </b>Please excuse the slow loading speed, this app
		is hosted on a free-tier AWS server<br> <br>
	</div>
	...
	<div class="container demotext">
		...
		<button class="btn btn-primary" type="button" data-toggle="collapse"
			...
			aria-controls="collapseExample">View App Features and
			Technologies</button>
		...
		<div class="collapse" id="collapseExample">
			<div class="card card-body">
				...
				*JAVA, Spring MVC, Spring Security, Hibernate, JavaScript, HTML,
				CSS, JQuery, Bootstrap, MySQL, AWS <br> <br>
				<h4>
					<b>App Features</b>
				</h4>
				*BCrypt Password Encoder, SQL Relational Databases, Java Mail
				Sender, JSR Custom Annotations <br> <br>
			</div>
		</div>
	</div>
